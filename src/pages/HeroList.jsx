        ...
        <>
            ...
            <div className='w-[80%] mr-auto ml-auto mt-5 bg-purple-950 rounded-sm'>
                <div className='w-[95%] mr-auto ml-auto text-2xl' id='hero'>
                    <Link to="/ireng" className='hover:bg-purple-800 w-full inline-block border-2 p-2 rounded mt-3'>Brody</Link>
                    <Link to="/change" className='hover:bg-purple-800 w-full inline-block border-2 p-2 rounded mt-3'>Change</Link>
                </div>
